    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='Total discount')),
                ('grand_total', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='Grand Total')),
                ('transfer_fee', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='payment fee')),
                ('final_total', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='final_total')),
