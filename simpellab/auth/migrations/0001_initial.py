    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='simpellab_auth.Person')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to='simpellab_auth.Person')),
            ],
            options={
                'verbose_name': 'Person address',
                'verbose_name_plural': 'Person addresses',
