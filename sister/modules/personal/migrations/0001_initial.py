    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sister_personal.Person')),
            ],
            options={
                'verbose_name': 'Wali',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_lain', models.CharField(blank=True, max_length=56, null=True)),
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sister_personal.Person')),
                ('wali', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sister_personal.Wali')),
            ],
            options={
                'verbose_name': 'Siswa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='sister_personal.Person')),
            ],
            options={
